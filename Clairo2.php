...
$query2 = "SELECT artist_name,COUNT(artist_name) as Most_Followed
	...
	WHERE userg.email_id = user_follows_artist.E_mail_id5 and artist.artist_id = user_follows_artist.E_artist_id5 and artist_id= 'cla1'
	GROUP BY (artist_name);";

$query3 = "SELECT artist_name,style
	FROM artist,artist_style 
	WHERE artist.artist_id = artist_style.artist_id7 and artist_id = 'cla1';";
...
echo "<div style='position:absolute;top:147px;left:920px;font-size:30px;'><font color= '#FFFFFF';> &nbsp;&nbsp;".$row2[1]."</font></div>";?>
<div style = "position:absolute;top:145px;left:600px;font-size:30px;"><font color= '#FFFFFF';>Number of Followers&nbsp;&thinsp;:    </font></div>

<?php
$result3 = pg_query($query3);
$row3 = pg_fetch_array($result3);
echo "<div style='position:absolute;top:190px;left:920px;font-size:25px;'><font color= '#FFFFFF';> &nbsp;&nbsp;".$row3[1]."</font></div>";?>

<div style = "position:absolute;top:185px;left:600px;font-size:30px;"><font color= '#FFFFFF';>Genre&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;:</font></div>
<?php

$result4 = pg_query($query4);
$row4 = pg_fetch_array($result4);
echo "<div style='position:absolute;top:233px;left:920px;font-size:30px;'><font color= '#FFFFFF';> &nbsp;&nbsp;".$row4[1]."</font></div>";?>
<div style = "position:absolute;top:233px;left:600px;font-size:30px;"><font color= '#FFFFFF';>Number of Albums&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</font></div>


<div style = "position:absolute;top:420px;left:300px;font-size:65px;"><font color= '#FFFFFF';>Albums</font></div>
<table>
<?php
  ...
  while($row5 = pg_fetch_row($result5)) {
	  $xyz = preg_replace('/\s+/', '', $row5[0]);?>
	 <?php if ($count % 3 == 0){
	  echo '<tr>';}?>
	  
    <td style = "padding:60px;width:100px;"><a href = "<?php echo $xyz.'.php' ?>"><img src="<?php echo $row5[1];?>" STYLE="WIDTH:210px; HEIGHT:210px;border-radius:50%;"/></a></td>
	    <?php if ($count % 3 == 0){
		echo '</tr>';
		}
    $count++;
...
$query2 = pg_query("SELECT e_id	FROM user_follows_artist WHERE E_mail_id5 = '$email_id' AND E_artist_id5 ='cla1'"); 	
...
<form method="post" action="pen2cal.php">
	<button class = "button button1 "type = "submit" name = "email_id" >UNFOLLOW</button>
	</form>
<?php } ?>
</body>
</html>