...
$query = "SELECT album_name,album_image
	...
	WHERE E_album_id6  = album_id and E_artist_id6 = artist_id and artist_id = 'cs1' and album_id = 'album_cs1';";

$query2 = "SELECT song_name,song_file,duration
		FROM song,album,artist_releases_albums
		where album_id = 'album_cs1' and song.album_idfk = album.album_id and E_album_id6  = album_id;";
...
$row6 = pg_fetch_array($result2);

?>
<body>
<?php echo "<div style='position:absolute;top:320px;left:265px;font-size:30px;'><font face = 'Poppins-Regular' color='#FFFFFF';> &nbsp;&nbsp;".$row[0]."</font></div>";?>
...
<div id="playlist">
        <div class="current-song"><a href="<?php echo $row2[1];?>"><?php echo $row2[0];?></a></div>
        <div><a href="<?php echo $row3[1];?>"><?php echo $row3[0];?></a></div>
        <div><a href = "<?php echo $row4[1];?>"><?php echo $row4[0];?></a></div>
		<div><a href = "<?php echo $row5[1];?>"><?php echo $row5[0];?></a></div>
				<div><a href = "<?php echo $row6[1];?>"><?php echo $row6[0];?></a></div>

</div>
<div id="playlist1">
        <div class="current-song"><?php echo $row2[2];?></div>
        <div><?php echo $row3[2];?></div>
        <div><?php echo $row4[2];?></div>
		<div><?php echo $row5[2];?></div>
