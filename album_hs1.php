...
$query = "SELECT album_name,album_image
	...
	WHERE E_album_id6  = album_id and E_artist_id6 = artist_id and artist_id = 'hs1' and album_id = 'album_hs1';";

$query2 = "SELECT song_name,song_file,duration
		FROM song,album,artist_releases_albums
		where album_id = 'album_hs1' and song.album_idfk = album.album_id and E_album_id6  = album_id;";
...
//$row8 = pg_fetch_array($result2);

?>
<body>
<?php echo "<div style='position:absolute;top:320px;left:290px;font-size:30px;height:20%;width:22%;text-align:center;'><font face = 'Poppins-Regular' color='#FFFFFF';> &nbsp;&nbsp;".$row[0]."</font></div>";?>
