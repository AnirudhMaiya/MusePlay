...
$query = "SELECT album_name,album_image
	...
	WHERE E_album_id6  = album_id and E_artist_id6 = artist_id and artist_id = 'cla1' and album_id = 'album_cla2';";

$query2 = "SELECT song_name,song_file,duration
		FROM song,album,artist_releases_albums
		where album_id = 'album_cla2' and song.album_idfk = album.album_id and E_album_id6  = album_id;";
...
?>
<body>
<?php echo "<div style='position:absolute;top:320px;left:370px;font-size:30px;'><font face = 'Poppins-Regular' color='#FFFFFF';> &nbsp;&nbsp;".$row[0]."</font></div>";?>
